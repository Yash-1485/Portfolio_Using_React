...
const LoadingScreen = ({ onComplete }) => {
    ...
    return (
        <div className='flex flex-col items-center justify-center inset-0 fixed bg-black z-50 text-gray-100'>
            <div className='mb-4 text-5xl font-mono font-bold'>{text}<span className='animate-blinking'>|</span></div>
            <div className="w-[400px] h-[3px] rounded bg-gray-800 relative overflow-hidden">
