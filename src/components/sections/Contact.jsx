...
const Contact = () => {
    ...
    const handleForm = (e) => {
        ...
        emailjs.sendForm(import.meta.env.VITE_SERVICE_ID, import.meta.env.VITE_TEMPLATE_ID, e.target, import.meta.env.VITE_PUBLIC_KEY)
            ...
            .catch(() => { toast.error("WOOPS! Something Went Wrong!! Please Try Again 😊") });
            ...
            <RevealOnScroll>
                <div className="w-80 md:w-150 mx-auto px-4 flex flex-col justify-center items-center">
                    ...
                    <form onSubmit={(e) => { handleForm(e) }} className="w-full space-y-4">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-blue-600 text-white font-medium px-6 py-3 rounded border border-blue-600 hover:bg-blue-600/90 hover:shadow-[3px_3px_0px_rgba(120,150,252,0.6)] transition-all duration-200">
